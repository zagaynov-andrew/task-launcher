...
void QueueTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QueueTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QueueTable::*)(QList<TaskHeader> * );
...
QT_INIT_METAOBJECT const QMetaObject QueueTable::staticMetaObject = { {
    &QTableWidget::staticMetaObject,
    qt_meta_stringdata_QueueTable.data,
    qt_meta_data_QueueTable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
